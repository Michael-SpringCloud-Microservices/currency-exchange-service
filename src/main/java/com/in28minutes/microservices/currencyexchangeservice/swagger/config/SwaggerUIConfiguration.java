...
public class SwaggerUIConfiguration {
	...
	public static final ApiInfo DEFAULT_API_INFO = new ApiInfo("Currency Exchange Swagger UI", "Currency Exchange API Documentation",
	...
	public Docket api(SwaggerAppParameters swaggerAppParameters){
		...
		.select().apis(RequestHandlerSelectors.basePackage("com.in28minutes.microservices.currencyexchangeservice.controller"))
