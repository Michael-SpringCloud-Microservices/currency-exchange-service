...
public class CurrencyExchangeController {
    ...
    public ExchangeValue retrieveExchangeValue(@PathVariable String from, @PathVariable String to){
        ...
        // The following log will be assigned a unique ID generated by Spring Cloud Sleuth
        // This unique id will be used for tracing the request and its log details across different components log via Zipkin UI
